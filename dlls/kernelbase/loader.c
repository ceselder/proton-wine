...
{
    WARN("[LOL_DEBUG] FUNCTION GetModuleHandleW");
    HMODULE ret;
...
{
    WARN("[LOL_DEBUG] FUNCTION GetModuleHandleExW");
    HMODULE ret = NULL;
    NTSTATUS status;
    void *dummy;
...
{
    WARN("[LOL_DEBUG] FUNCTION LoadLibraryW");
...
{
    WARN("[LOL_DEBUG] FUNCTION LoadLibraryExW");
    UNICODE_STRING str;
    HMODULE module;
