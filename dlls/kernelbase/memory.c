...
{
    WARN("[LOL_DEBUG] FUNCTION GetSystemInfo");
...
{
    WARN("[LOL_DEBUG] FUNCTION VirtualAlloc");
...
{
    WARN("[LOL_DEBUG] FUNCTION VirtualAllocEx");
    LPVOID ret = addr;
...
{
    WARN("[LOL_DEBUG] FUNCTION VirtualFree");
...
{
    WARN("[LOL_DEBUG] FUNCTION VirtualFreeEx");
...
{
    WARN("[LOL_DEBUG] FUNCTION VirtualProtect");
...
{
    WARN("[LOL_DEBUG] FUNCTION GlobalAlloc");
...
BOOL WINAPI DECLSPEC_HOTPATCH GetLogicalProcessorInformation( SYSTEM_LOGICAL_PROCESSOR_INFORMATION *buffer,
                                                              DWORD *len )
{
    WARN("[LOL_DEBUG] FUNCTION GetLogicalProcessorInformation");
    NTSTATUS status;
...
{
    WARN("[LOL_DEBUG] FUNCTION GetNumaHighestNodeNumber");
    FIXME( "semi-stub: %p\n", node );
    *node = 0;
    return TRUE;
}
