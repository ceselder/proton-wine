...
{
    WARN("[LOL_DEBUG] FUNCTION CloseHandle");
...
{
    WARN("[LOL_DEBUG] FUNCTION DuplicateHandle");
...
{
    WARN("[LOL_DEBUG] FUNCTION IsProcessorFeaturePresent");
...
{
    WARN("[LOL_DEBUG] FUNCTION TerminateProcess");
    if (!handle)
    {
...
{
    WARN("[LOL_DEBUG] FUNCTION GetCommandLineA");
...
{
    WARN("[LOL_DEBUG] FUNCTION GetCommandLineW");
...
{
    WARN("[LOL_DEBUG] FUNCTION GetStartupInfoW");
    *info = startup_infoW;
}
...
{
    WARN("[LOL_DEBUG] FUNCTION SetStdHandle");
    switch (std_handle)
    {
...
{
    WARN("[LOL_DEBUG] FUNCTION GetEnvironmentStringsW");
    LPWSTR ret;
    SIZE_T len;
...
{
    WARN("[LOL_DEBUG] FUNCTION FreeEnvironmentStringsW");
