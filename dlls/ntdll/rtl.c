...
{
    WARN("[LOL_DEBUG] FUNCTION RtlEncodePointer");
...
{
    WARN("[LOL_DEBUG] FUNCTION RtlInitializeSListHead");
#ifdef _WIN64
...
{
    WARN("[LOL_DEBUG] FUNCTION RtlQueryDepthSList");
#ifdef _WIN64
...
{
    WARN("[LOL_DEBUG] FUNCTION RtlInterlockedFlushSList");
...
{
    WARN("[LOL_DEBUG] FUNCTION RtlInterlockedPushEntrySList");
    SLIST_HEADER old, new;
